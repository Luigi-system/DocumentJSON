...
import { BoldIcon, ItalicIcon, AlignLeftIcon, AlignCenterIcon, AlignRightIcon, InformationCircleIcon, MagicWandIcon, ChevronDownIcon, ChevronRightIcon, CogIcon, DocumentIcon, DocumentIconOutline } from '@/shared/icons';
